...
def list_account_statuses(content_api, merchant_id, next_page = nil)
  content_api.list_account_statuses(
    merchant_id,
    ...
    list_account_statuses(content_api, merchant_id, res.next_page_token)
  end
end
