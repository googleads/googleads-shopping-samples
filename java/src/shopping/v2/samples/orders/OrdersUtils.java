package shopping.v2.samples.orders;
...
import com.google.api.services.content.model.OrderPaymentMethod;
...
public class OrdersUtils {
  public static void printOrder(Order order) {
    ...
    if (order.getNetAmount() != null) {
      Price amount = order.getNetAmount();
    ...
    System.out.printf("- Shipping option: %s%n", order.getShippingOption());
